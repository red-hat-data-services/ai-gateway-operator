...
// ModelsAsAServiceReady=True when modelsAsAService is Managed, both the
// maas-controller and ai-gateway-controller Deployments are ready, and Config
// doesn't exist yet (bootstrap in progress — don't block).
